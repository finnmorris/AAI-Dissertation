...
Three models are trained and compared: **XGBoost**, **Ridge logistic regression**, and **Lasso logistic regression**. Serie A 2015/16 is held out entirely as a test set across all models.
